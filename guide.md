...
1.  **Launch**: Run `npm start` in your terminal (powershell). Do it in the folder/directory where you installed **Perplexity Codex**. This starts the server (http://localhost:3000/viewer.html) and **automatically opens the viewer** in your browser.

2.  **⚙️ Settings** - configure before the first run! 
	- **Login**: Enter your email. This will be used automatically by the auto-browser engine
...
6. Click on an article to view. You can see the source text of the markdown file or the on-line version of it - see the buttons top-right
